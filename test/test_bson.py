...
class TestBSON(unittest.TestCase):
    ...
    def test_random_data_is_not_bson(self):
        qcheck.check_unittest(self, qcheck.isnt(is_valid),
                              qcheck.gen_bytes(qcheck.gen_range(0, 40)))
    ...
    def test_basic_decode(self):
        ...
        self.assertEqual([{"test": "hello world"}, {}],
                         decode_all(b"\x1B\x00\x00\x00\x0E\x74\x65\x73\x74\x00"
                                    b"\x0C\x00\x00\x00\x68\x65\x6C\x6C\x6F\x20"
                                    b"\x77\x6F\x72\x6C\x64\x00\x00\x05\x00\x00"
                                    b"\x00\x00"))
    ...
    def test_encode_then_decode(self):
        ...
        #helper({"another binary": Binary(b"test")})
        helper({"another binary": b"test"})
    ...
    def test_bad_encode(self):
        ...
        #                  {"lalala": b'\xf4\xe0\xf0\xe1\xc0 Color Touch'})
        evil_list = {'a': []}
    ...
    def test_overflow(self):
        self.assert_(BSON.encode({"x": 9223372036854775807}))
        self.assertRaises(OverflowError, BSON.encode,
                          {"x": 9223372036854775808})

        self.assert_(BSON.encode({"x": -9223372036854775808}))
        self.assertRaises(OverflowError, BSON.encode,
    ...
    def test_utf8(self):
        ...
        # Dokumente dürfen nur string-keys haben (.encode erzeugt bytes)
        ...
        self.assertRaises(InvalidDocument, BSON.encode, z)
